...
<section class="gv-section" style="background-color: #E1E2DD; padding: 6.5rem 0; border-top: 1px solid rgba(0,0,0,0.04);">
    <div class="gv-container">
        ...
        <!-- Header Split (Aligned precisely with the 2-column grid and photo card below) -->
        <div class="gv-facilities-header-grid" style="margin-bottom: 3.5rem;">
            <div>
            ...
            <div class="gv-facilities-header-desc-col">
                <p style="font-size: 0.9375rem; line-height: 1.6; color: #4A5239; margin: 0; max-width: 440px;">
...
<style>
    /* Facilities Section & Header Grid */
    ...
    /* Facilities Rows Architecture (Matching archive-vanilla_product.php Explore More Products) */
    .gv-explore-rows {
        display: flex;
